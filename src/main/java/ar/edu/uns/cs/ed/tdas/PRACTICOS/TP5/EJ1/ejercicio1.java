...
import ar.edu.uns.cs.ed.tdas.PRACTICOS.TP4.EJ1.ElementIterator;
...
public class ejercicio1{
    ...
    public <K,V> Dictionary<K,V> acomodar(Dictionary<K,V> d){
        Map<K,V> mapa = new MapaAbierto<K,V>();
        ...
        Dictionary<K,V> retorno = new OpenDictionary<>();
    ...
    public Map<Character,Integer> mapearlista(PositionList<Character> lista){
            ...
            Map<Character, Integer> retorno = new MapaAbierto<>();
            while(iterador.hasNext()){
