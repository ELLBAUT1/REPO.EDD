...
import ar.edu.uns.cs.ed.tdas.PRACTICOS.TP6.EJ1.Arbol;
...
public class TreeTest {
	...
	private <E> Queue<E> getAuxQueue() {
		Queue<E> q = null;
		q = new QueueArray<E>(); //TODO: Descomentar y crear instancia de Queue<E> auxiliar
		return q;
	}
	...
	private <E> PositionList<E> getAuxPositionList() {
		...
		l = new DoubleLinkedList<E>(); //TODO: Descomentar y crear instancia de PositionList<E> auxiliar
		return l;
	}
